...
public class Point {
    ...
    /**
     * Default constructor so that JSON parser can create point. Do not use.
     */
    public Point(){
    ...
    /**
     * sets whether the Point has been marked as a builtIn or not.
     * @param builtIn whether the Point has been marked as a builtIn or not.
     */
